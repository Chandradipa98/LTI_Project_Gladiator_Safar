...
public class Main {
	...
	public static void main(String[] args) {
		...
		Payment pay1 = new Payment(1000, "Netbanking");
		Payment pay2 = new Payment(1000, "Credit Card");
		Payment pay3 = new Payment(1000, "Paytm");
		Payment pay4 = new Payment(1000, "Debit Card");
		Payment pay5 = new Payment(1000, "Google Pay");
		...
		res1.setTotalFare(res1.getBus().getBaseFare()*res1.getNoOfSeats()+res1.getPayment().getChargedFare());
		res2.setTotalFare(res2.getBus().getBaseFare()*res2.getNoOfSeats()+res2.getPayment().getChargedFare());
		res3.setTotalFare(res3.getBus().getBaseFare()*res3.getNoOfSeats()+res3.getPayment().getChargedFare());
		res4.setTotalFare(res4.getBus().getBaseFare()*res4.getNoOfSeats()+res4.getPayment().getChargedFare());
		res5.setTotalFare(res5.getBus().getBaseFare()*res5.getNoOfSeats()+res5.getPayment().getChargedFare());
